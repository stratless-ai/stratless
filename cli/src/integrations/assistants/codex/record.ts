 ...
 *
 * The second Record (see `contracts.ts` for the contract, `assistants/registry.ts` for the registry). It inherits
...
import { PASTE_BOUND, isTypedMessage, type DriftReport, type Session, type Turn } from '../../contracts.js';
import { archiveSlice, codexHome, codexSessions } from './paths.js';

export { archiveSlice, codexHome } from './paths.js';

/** This Record's id — one source, shared with this assistant's adapter. */
