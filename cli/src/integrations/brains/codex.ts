 ...
 * is not support.
 *
 * THE TWO INVARIANTS, SATISFIED IN CODEX'S OWN VOCABULARY (see `contracts.ts`'s `Brain`):
 *
...
import { codexHome } from '../assistants/codex/paths.js';
import { recordUsage } from '../../runner/usage.js';
import type { Brain, BrainAnswer, BrainCost } from '../contracts.js';
