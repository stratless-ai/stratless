...
import { MODEL, modelDir } from './embed.js';
...
/** Where the runtime lives — beside the model, inside the one directory `stop` can reason about.
 *  Override with STRATLESS_RUNTIME_DIR (tests, sandboxes). */
