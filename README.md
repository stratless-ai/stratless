...
<p align="center">
  <img src="assets/profile-hero.svg?v=8" alt="A sample stratless profile printed in a terminal: who you're working with, one instruction per line with its real count. What to offer me before I ask: offer to enter a planning step before touching any implementation, 258 times with 28 slips. What to catch for me: catch unverified claims of done work; they want it double-checked before being told it's finished, 122 times. How to talk to me: talk in short imperatives back, matching their terse next-action style, 302 times. Then stratless update loads it and the assistant talks to a person, not a blank." width="620">
</p>
