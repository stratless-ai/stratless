...
<p align="center">
  <img src="assets/profile-hero.svg?v=9" alt="A sample stratless profile printed in a terminal: who you're working with, one instruction per line with its real count. What to offer me before I ask: offer to enter a planning step before touching any implementation, 265 times with 28 slips. What to catch for me: catch language or framing that undersells quality; they will reject a term or shortcut they find weak, 169 times. How to talk to me: let them lay out multi-part strategic reasoning and respond with a clear stance, not just agreement, 236 times and rising. Then stratless update loads it and the assistant talks to a person, not a blank." width="620">
</p>
