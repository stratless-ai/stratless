...
stratless reads your coding assistant's own history and loads a profile back into it. The core is the same for every tool: read your sessions, judge whether understanding transferred, write a `HUMAN.md`, load it. Only the wiring differs per assistant, where the transcripts live, how the profile loads, and what cleanup you have to guard against.
