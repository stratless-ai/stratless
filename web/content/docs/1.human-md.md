...
`HUMAN.md` is the person layer. It lives at `~/.stratless/HUMAN.md`, and your assistant loads it at the start of every session, so it starts already knowing who it's talking to instead of a blank.
