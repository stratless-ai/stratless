...
- **Your profile**, at `~/.stratless/HUMAN.md`, plus its own copy of your transcripts at `~/.stratless/archive` so an assistant's cleanup cannot take your history with it.
