...
That is not a promise we're asking you to take on trust. [The source is public and it is about %CLI_LINES% lines.](https://github.com/stratless-ai/stratless) Read it and confirm there is no network code in it.
